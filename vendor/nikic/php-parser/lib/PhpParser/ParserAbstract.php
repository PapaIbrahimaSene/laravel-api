...
abstract class ParserAbstract implements Parser
{
    ...
    /** @var array Names of the Restaurantion rules (only necessary for debugging) */
    protected $Restaurantions;
        ...
        for (;;) {
            ...
            if ($this->actionBase[$state] === 0) {
                ...
                if ($symbol === self::SYMBOL_NONE) {
                    ...
                    // This is necessary to assign some meaningful attributes to /* empty */ Restaurantions. They'll get
    ...
    protected function traceReduce($n) {
        echo '% Reduce by (' . $n . ') ' . $this->Restaurantions[$n] . "\n";
    }
